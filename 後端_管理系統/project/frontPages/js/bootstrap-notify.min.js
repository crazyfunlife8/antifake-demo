...
(function (c) {
  ...
  c.extend(g.prototype, {
    ...
    buildNotify: function () {
      ...
      ((0 >= this.settings.delay && !this.settings.showProgressbar) ||
    ...
    placement: function () {
      ...
      c(
        ...
        return (b = Math.max(
          b,
          parseInt(c(this).css(f.placement.from)) +
            parseInt(c(this).outerHeight()) +
            parseInt(f.spacing),
        ));
      });
    ...
    bind: function () {
      ...
      if (0 < this.settings.delay) {
        ...
        var b = setInterval(function () {
          ...
          if (
            ("false" === a.$ele.data("data-hover") &&
              "pause" == a.settings.mouse_over) ||
            "pause" != a.settings.mouse_over
          ) {
    ...
    close: function () {
      ...
      setTimeout(function () {
        if (!e && (a.$ele.remove(), a.settings.onClosed))
  ...
  c.notify = function (a, b) {
    return new g(this, a, b).notify;
  };
  c.notifyDefaults = function (a) {
    return (f = c.extend(!0, {}, f, a));
  };
  c.notifyClose = function (a) {
    "undefined" === typeof a || "all" == a
      ? c("[data-notify]").find('[data-notify="dismiss"]').trigger("click")
      : c('[data-notify-position="' + a + '"]')
          .find('[data-notify="dismiss"]')
          .trigger("click");
  };
});
